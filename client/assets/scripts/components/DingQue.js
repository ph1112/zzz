cc.Class({
    ...
    showDingQueChoice:function(){
         ...
         cc.find("Canvas/game/0/holds").active = false;         
         cc.find("Canvas/game/2/holds").active = false;           
        cc.find("Canvas/game/1/holds").active = false;
        cc.find("Canvas/game/3/holds").active = false;
