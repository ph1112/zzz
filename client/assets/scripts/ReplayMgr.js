...
cc.Class({
    ...
    takeAction:function(){
        ...
        else if(action.type == ACTION_LIANG){data.index
            //console.log("hu");       
           cc.vv.gameNetMgr.dispatchEvent('game_LiangDao_notify',{seatindex:cc.vv.gameNetMgr.seats[action.si],index:action.pai,holds:null});     
            return 0.5;
        }     
    }
